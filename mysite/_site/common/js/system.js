...
const $GET = (function () {
    ...
    const base = {
        ...
        getObject: function (path, decode_flag, auto_type, rewrite) {
            ...
            const _obj = rewrite ? obj : new Object();
            let query_str = decodeURI(
    ...
    const base = {
        ...
        out: function (args, force) {
            ...
            if (force && typeof key !== "undefined") {
                const value = checkVar(args.value, "1", true);
                const time = checkVar(args.time, null);
                const path = checkVar(args.path, "/");
                const _update = checkVar(args.update, true);
                const setDate = "";
                if (value === null) {
                    value = 0;
                    setDate = ";max-age=0";
